...
export default function UserProfileMenu({
  ...
  // For sidebar variant, show a simple icon button
  if (variant === "sidebar") {
    return (
      <>
        <div className="relative" ref={menuRef}>
          <button
            ...
            className="text-slate-300/80 hover:text-white p-1 transition-colors"
            title="Settings"
          >
          ...
          {/* Dropdown Menu */}
          {menuOpen && (
            <div className="absolute right-0 bottom-12 w-48 bg-white rounded-lg shadow-xl border border-gray-200 z-50">
              <div className="py-2">
                <button
                  onClick={() => {
          ...
          <div className="px-6 py-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-sky-500 text-gray-900 bg-white"
